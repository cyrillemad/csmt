...
import "github.com/cyrillemad/csmt/internal/encode"
...
type InventoryResponse = encode.InventoryResponse

type InventoryAsset = encode.InventoryAsset

type InventoryDescription = encode.InventoryDescription

type ItemDescription = encode.ItemDescription

type InventoryAction = encode.InventoryAction

type InventoryTag = encode.InventoryTag
